...
Бот синтезирует русский текст в речь и распознает короткие голосовые сообщения.
...
/speed <code>0.1 .. 2.0</code> - для выбора скорости [например <code>/speed 0.55</code>].
